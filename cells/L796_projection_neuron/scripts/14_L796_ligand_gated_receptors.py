...
NACHR_CAVEAT = (
    ...
    "vetted nAChR .mod file was available in shared/mechanisms/medlock_267056, so this is a documented "
...
def write_report(s1, summation_rows, s2, s3, locs):
    ...
    lines.append("")
    lines.append(
        "No vetted P2X3/P2X4 or 5-HT3 .mod file is available in `shared/mechanisms/medlock_267056`. "

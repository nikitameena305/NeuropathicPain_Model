...
RUN (from the repository root):
    ./shared/mechanisms/medlock_267056/x86_64/special -python cells/L796_projection_neuron/scripts/19_temperature_sensitivity_fixed_intrinsic.py
    # single temperature only: L796_CELSIUS=37 ./shared/mechanisms/medlock_267056/x86_64/special -python cells/L796_projection_neuron/scripts/19_temperature_sensitivity_fixed_intrinsic.py
"""
...
audit = []
for mp in sorted(glob.glob(str(REPOSITORY_ROOT / "shared/mechanisms/medlock_267056/*.mod"))):
...
md.append("\n## Mechanism temperature audit (shared/mechanisms/medlock_267056)\n")

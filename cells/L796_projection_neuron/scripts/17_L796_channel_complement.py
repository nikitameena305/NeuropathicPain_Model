...
def main():
    ...
    no_T_mod = "no vetted T-type Ca .mod file is available in shared/mechanisms/medlock_267056"
    if t_type_present:
        t_type_reason = (
...
def write_report(evidence_rows, a_density, a_rows, a_zero_row, a_best_row, latencies_with,
    ...
    lines.append(
        ...
        "`./shared/mechanisms/medlock_267056/x86_64/special -python`). All mechanisms are from ModelDB accession "

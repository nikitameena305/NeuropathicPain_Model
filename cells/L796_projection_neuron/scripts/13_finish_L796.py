...
def safe_insert(sec, mech):
    try:
        ...
        print("cd shared/mechanisms/medlock_267056 && nrnivmodl && cd ../../..")
        print("./shared/mechanisms/medlock_267056/x86_64/special -python cells/L796_projection_neuron/scripts/13_finish_L796.py")
        raise e

...
summary_path = "results/ap_features/L796_step5_somatic_AP_features_summary.csv"
if not os.path.exists(summary_path):
    raise FileNotFoundError("Run extract_step5_somatic_AP_features.py first.")
...
rheobase_known = "between 20 and 40 pA"
...
if row60 is not None:
    table.extend([
        ...
        },
        {
            ...
            "Interpretation": "Use cautiously; Ruscheweyh is not L796-specific",
        },
        {
...
out_path = "validation/ap_features/L796_model_vs_literature_validation_table.csv"
out.to_csv(out_path, index=False)

md_path = "validation/ap_features/L796_model_vs_literature_validation_table.md"

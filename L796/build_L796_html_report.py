...
if not (ROOT / "results").exists() and (Path.home() / "NeuropathicPain_Model/L796/results").exists():
    ROOT = Path.home() / "NeuropathicPain_Model/L796"
...
<ul>
<li><b>NEURON</b> (compartmental simulator) — runs the biophysical model; mechanisms compiled with <code>nrnivmodl</code> into <code>./external/SDHmodel/x86_64/special</code>.</li>
